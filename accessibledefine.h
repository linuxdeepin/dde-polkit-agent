...
#define SET_WIDGET_ACCESSIBLE_WITH_DESCRIPTION(classname,accessibletype,accessiblename,accessdescription)  class Accessible##classname : public QAccessibleWidget\
{\
    public:\
    FUNC_CREATE(classname,accessibletype,accessdescription)\
    QString text(QAccessible::Text t) const override;\
    void *interface_cast(QAccessible::InterfaceType t) override{\
    switch (t) {\
    case QAccessible::ActionInterface:\
...
/*******************************************简化使用*******************************************/
#define SET_WIDGET_ACCESSIBLE(classname,aaccessibletype,accessiblename)        SET_WIDGET_ACCESSIBLE_WITH_DESCRIPTION(classname,aaccessibletype,accessiblename,"")
